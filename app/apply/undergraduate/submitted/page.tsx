...
export default function UndergraduateSubmitted() {
  const [openSections, setOpenSections] = useState<{ [key: string]: boolean }>({
    '10': true // Set the withdraw panel open by default
  })
      ...
      <div className="container py-12">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/4">
            <ApplySidebar currentPath="/apply/undergraduate/submitted" />
          </div>
          ...
          <div className="md:w-3/4">
            ...
            <div className="space-y-3">
              ...
              <div className="border border-gray-200 rounded overflow-hidden">
                ...
                >
                  <h4 className="text-lg font-medium">My college has a policy where they do not complete recommendation forms. What should I do?</h4>
                  <span>{openSections['4'] ? '−' : '+'}</span>
                </div>
                {openSections['4'] && (
                  <div className="p-4 bg-white">
                    <p>
                      We understand some institutions have policies where they do not complete recommendation forms on behalf of an applicant. Colleges/universities with this policy typically have a policy letter that they provide to students. Please email the policy letter to <a href="mailto:scholarship@lu-memorial.org" className="text-[#2c5282] hover:underline">scholarship@lu-memorial.org</a>, including your name, school name, and date of birth in the email. The policy letter will be used to update your checklist item in your Lu Scholar portal.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border border-gray-200 rounded overflow-hidden">
                ...
                {openSections['5'] && (
                  <div className="p-4 bg-white">
                    ...
                    <p>
                      <strong>If you need to have a letter of recommendation emailed to us, please have your recommender also indicate the type of recommendation in the email.</strong>
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border border-gray-200 rounded overflow-hidden">
                ...
                >
                  <h4 className="text-lg font-medium">I have been out of college for several years and am substituting a professional letter for an academic evaluation. My letter has been sent already, but it is not showing on my checklist. What should I do?</h4>
                  <span>{openSections['6'] ? '−' : '+'}</span>
                </div>
                {openSections['6'] && (
                  <div className="p-4 bg-white">
                    <p>
                      Please email <a href="mailto:scholarship@lu-memorial.org" className="text-[#2c5282] hover:underline">scholarship@lu-memorial.org</a> with the name of the recommender and a request for us to update the letter from an optional recommendation to an academic evaluation.
                    </p>
                  </div>
                )}
              </div>
