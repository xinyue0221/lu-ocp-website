...
export default function HighSchoolInterview() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: (
        <ul className="list-disc pl-6 space-y-2">
          <li>High school applicants who apply through either the Early Action or Regular Decision rounds may be invited to an optional interview.</li>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Prior to the interview, you may want to think about:
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Your academic achievements and how they demonstrate academic excellence.</li>
              <li>Experiences that showcase your innovative thinking.</li>
              <li>Examples of your commitment to creating positive change.</li>
    ...
    // Step 4: During the Interview
    {
      ...
      answer: (
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>The interview is a one-on-one experience. Parents, siblings, and friends should not be present during the interview.</li>
          <li>Be prepared to discuss your academic achievements, extracurricular activities, and future goals.</li>
      ...
      <div className="container py-12">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/4">
            <ApplySidebar currentPath="/apply/high-school/interview" />
          </div>
